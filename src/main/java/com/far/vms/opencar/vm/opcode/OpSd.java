...
public class OpSd {
    ...
    public OpSd setOpcode(int opcode) {
        this.opcode = opcode;
        return this;
    }
    ...
    public OpSd setFunc3(int func3) {
        this.func3 = func3;
        return this;
    }

    public OpSd setCtx(Cpu ctx) {
        this.ctx = ctx;
        return this;
    }

    public OpSd setCode(int code) {
        this.code = code;
        return this;
    }
    ...
    public void process() {
        ...
        if (Debugger.Stat.DEBUG == StaticRes.debugger.getStat()) {
            String info = String.format("write mem 0x%x",mAddr);
