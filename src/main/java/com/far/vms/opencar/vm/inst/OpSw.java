...
public class OpSw {
    ...
    public OpSw setOpcode(int opcode) {
        this.opcode = opcode;
        return this;
    }
    ...
    public OpSw setFunc3(int func3) {
        this.func3 = func3;
        return this;
    }

    public OpSw setCtx(Cpu ctx){
        this.ctx = ctx;
        return this;
    }

    public OpSw setCode(int code) {
        this.code = code;
        return this;
    }
    ...
    public void process(){
        ...
        StaticRes.bus.storeDw(mAddr,val.intValue());
