...
import com.far.vms.opencar.instruct.inst.OpAddi;
import com.far.vms.opencar.instruct.inst.OpSlli;
...
public class Op0x13 implements IOpcodeTypes {
     ...
     * @data 2022/11/23
     */
    public void opAndi(int[] ops, Cpu ctx) {
        int rd, rs1, imm;
        rd  = ops[1];
        rs1 = ops[3];
        imm = ops[4];
